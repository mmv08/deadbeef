...
static inline bool hasPrefix(uchar const *d, __constant uchar const *prefix,
                             uint prefixLength) {
...
__kernel void hashMessage(__constant uchar const *d_message,
                          ...
                          __constant uchar const *d_prefix, uint prefixLength,
...
#pragma unroll
  ...
  if (hasPrefix(digest, d_prefix, prefixLength)) {
